...
{
    public class ArtFileProvider : PhysicalFileProvider, IArtFileProvider
    {
        /// <summary>
        /// Initializes a new instance of a ArtFileProvider
        /// </summary>
        /// <param name="hostingEnvironment">Hosting environment</param>
        public ArtFileProvider(IHostingEnvironment hostingEnvironment)
