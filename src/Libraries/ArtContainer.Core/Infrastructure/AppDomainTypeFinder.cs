...
{
    /// <summary>
    /// A class that finds types needed by Art by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        protected IArtFileProvider _fileProvider;

        #endregion

        #region Ctor
        public AppDomainTypeFinder(IArtFileProvider fileProvider = null)
        {
