...
namespace ArtContainer.Core
{
    ...
    public partial class CommonHelper
    {
        ...
        /// </summary>
        public static IArtFileProvider DefaultFileProvider { get; set; }
        ...
        public static string EnsureSubscriberEmailOrThrow(string email)
        {
            ...
            {
                throw new ArtException("Email is not valid.");
            }
        ...
        public static void SetProperty(object instance, string propertyName, object value)
        {
            ...
            if (pi == null)
                throw new ArtException("No property '{0}' found on the instance of type '{1}'.", propertyName, instanceType);
            if (!pi.CanWrite)
                throw new ArtException("The property '{0}' on the instance of type '{1}' does not have a setter.", propertyName, instanceType);
